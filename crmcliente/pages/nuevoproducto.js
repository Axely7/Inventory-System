            ...
            <div className="flex justify-center mt-5">
                <div className="w-full max-w-lg">
                    ...
                    >
                        ...
                        <input type="submit" className="bg-gray-800 w-full mt-5 p-2 text-white uppercase font-bold hover:bg-gray-900 cursor-pointer" value="Agregar Nuevo Producto"></input>
