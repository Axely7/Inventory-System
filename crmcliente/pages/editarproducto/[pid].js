...
const EditarProducto = () => {
    ...
    const schemaValidacion = Yup.object({
        ...
        existencia: Yup.number().required('Agrega la cantidad disponible')
    ...
    const actualizarInfro = async valores =>{
                    ...
                    >
                        ...
                        >
                            <div className="mb-4">
                                    ...
                                    type="text" placeholder="Nombre Producto" onChange={props.handleChange} onBlur={props.handleBlur} value={props.values.nombre}
                                    ></input>
                            </div>
                            ...
                            <div className="mb-4">
                                    ...
                                    type="number" placeholder="Cantidad Disponible" onChange={props.handleChange} onBlur={props.handleBlur} value={props.values.existencia}
                                    ></input>
                            </div>
                            ...
                            <div className="mb-4">
                                    ...
                                    type="number" placeholder="Precio Producto" onChange={props.handleChange} onBlur={props.handleBlur} value={props.values.precio}
                                    ></input>
                            </div>
